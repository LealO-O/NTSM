...
class NSTM(nn.Module):
    ...
    '''
    def __init__(self, vocab_size, num_topics=50, en_units=400, dropout=0.25, pretrained_WE=None, train_WE=True, embed_size=400, recon_loss_weight=0.07, sinkhorn_alpha=20):
        super().__init__()
    ...
    def forward(self, input):
        ...
        # print("sh_loss: ",sh_loss.sum(dim=1))

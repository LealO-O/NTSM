...
class NSTM(nn.Module):
    ...
    '''
    def __init__(self, vocab_size, num_topics=50, en_units=600, dropout=0.25, pretrained_WE=None, train_WE=True, embed_size=600, recon_loss_weight=0.07, sinkhorn_alpha=20):
        super().__init__()
